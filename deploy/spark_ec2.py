...
def parse_args():
    ...
    parser.add_option("--master-ami", help="Amazon Machine Image ID to use "
                      "on master (leave empty for same as --ami)", default="")
    parser.add_option(
...
def launch_cluster(conn, opts, cluster_name):
    ...
    try:
        ...
        print >> stderr, "Could not find master AMI " + opts.master_ami

    print "Spark Slave AMI: " + opts.ami
    print "Spark Master AMI: " + opts.master_ami
...
def setup_cluster(conn, master_nodes, slave_nodes, opts, deploy_ssh_key):
    ...
    modules = ['spark', 'shark', 'ephemeral-hdfs', 'persistent-hdfs',
               'mapreduce', 'spark-standalone', 'tachyon', 'sampleclean']
